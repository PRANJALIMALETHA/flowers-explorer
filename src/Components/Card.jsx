...
const Card = (props) => {
    ...
    return (
        <div className="flex flex-col md:relative">
            <div className="absolute top-[-80 rem] z-10 mx-auto ">
            ...
            <div className="text-center mt-4">
                <p className="text-violet-300 text-sm uppercase">{review.type}</p>
            </div>
            ...
            <div className="text-center mt-4 text-slate-500 ">{review.description}</div>
